...
<%
     ...
     * Permite ao administrador consultar carteiras de clientes,
     * adicionar saldo, retirar saldo e registar os movimentos para auditoria.
     */
                ...
                if (valor <= 0) {
                    ...
                    if (erro.equals("")) {
                        ...
                        if ("adicionar".equals(operacao)) {
                            ...
                            /*
                             * Só permite retirar saldo se o cliente tiver saldo suficiente.
                             */
                            if (valor > saldoAtual) {
...
<div class="container-tabela">
    ...
    <div class="form-admin-box">
        ...
        <form method="post" action="admin_carteiras.jsp">
