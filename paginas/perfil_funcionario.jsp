        ...
        if (request.getMethod().equalsIgnoreCase("POST")) {
            ...
            if (novoNome == null || novoNome.trim().isEmpty()) {
                ...
                if (novaPassword == null || novaPassword.trim().isEmpty()) {
                    ...
                    /*
                     * Se o funcionário escrever uma nova password,
...
<div class="container">
    ...
    <div class="header" style="text-align: center; margin-bottom: 20px;">
        <h1 style="margin: 0 0 5px 0;">Perfil do Funcionário</h1>
    ...
    <form method="post" action="perfil_funcionario.jsp" accept-charset="UTF-8">
