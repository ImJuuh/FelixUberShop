...
<%
     ...
     * Permite ao funcionário visualizar e editar os seus próprios dados pessoais.
     */

    String perfil = (String) session.getAttribute("perfil");
    Integer userId = (Integer) session.getAttribute("user_id");

    if (perfil == null || !perfil.equals("funcionario") || userId == null) {
    ...
    try {
        ...
        if (request.getMethod().equalsIgnoreCase("POST")) {
            ...
            if (novoNome == null || novoNome.trim().isEmpty()) {
                ...
                String sql =
                    ...
                    "WHERE id = ? AND perfil = 'funcionario'";
         ...
         */
        String sqlDados = "SELECT * FROM utilizadores WHERE id = ? AND perfil = 'funcionario'";
...
<head>
    <meta charset="UTF-8">
    <title>Perfil do Funcionário - FelixUberShop</title>
...
<div class="container">
    ...
    <form method="post" action="perfil_funcionario.jsp">
