...
<%
    ...
    try {
        ...
        /*
         * Alterar estado da encomenda para validada.
         */
        ...
        /*
         * Alterar estado da encomenda para entregue.
         */
...
<head>
    <meta charset="UTF-8">
    <title>Gestão de Encomendas - FelixUberShop</title>
...
<div class="container-tabela">
    ...
    <div class="header">
        ...
        <p>Olá, <%= nomeSessao %>. Aqui pode consultar e gerir as encomendas dos clientes.</p>
    </div>
            ...
            <tr>
                ...
                <td>
                    <% if (estado.equals("pendente")) { %>
                        ...
                        <a class="btn-pequeno"
                           href="admin_encomendas.jsp?acao=validar&id=<%= id %>"
                    ...
                    <% } else if (estado.equals("validada")) { %>
                        ...
                        <a class="btn-pequeno"
                           href="admin_encomendas.jsp?acao=entregar&id=<%= id %>"
